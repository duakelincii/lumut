                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                placeholder="Nama" value="{{ $data->name }}" name="name">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last-name-column" class="form-control"
                                                placeholder="Username" value="{{ $data->username }}" name="username">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="last-name-column" class="form-control"
                                                placeholder="password" value="{{ $data->password }}" name="password">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="role" id="" class="form-control">
                                                ...
                                                <option value="Author" {{ $data->role == 'Admin' ? 'selected' : '' }}>
                                                    Author</option>
                                            </select>
                                        </div>
                                    </div>
